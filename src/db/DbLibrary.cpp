...
#define GU_CURRENT_DBVERSION    "21"
    ...
    */
    ...
    int guDbLibrary::GetPlayListSongs(const wxArrayInt &ids, const wxArrayInt &types, guTrackArray *tracks,
                                      wxArrayInt *setids, wxLongLong *len, wxLongLong *size, const int order,
                                      const bool orderdesc)
    {
    ...
    int guDbLibrary::GetSongs(const guTreeViewFilterArray &filters, guTrackArray *Songs,
                              const wxArrayString &textfilters, const int order, const bool orderdesc)
    {
        wxString query;
        wxSQLite3ResultSet dbRes;
        guTrack *Song;
