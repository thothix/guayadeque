...
void guPrefDialog::BuildLibraryPage()
{
	...
	m_LibOptCollationSearchChkBox = new wxCheckBox(m_LibOptPanel, wxID_ANY, _("Enable search compatible with accented characters in the library (Slow)"), wxDefaultPosition, wxDefaultSize, 0 );
